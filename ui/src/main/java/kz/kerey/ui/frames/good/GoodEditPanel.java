...
public class GoodEditPanel extends JPanel {
	...
	public GoodWrapper getUpdatedGoodWrapper() {
		...
		this.updatedGood.setCountPerBox(Long.valueOf(this.countPerBoxField
				.getText()));
		this.updatedGood.setCountSellable(Long.valueOf(this.countSellableField
				.getText()));
	...
	private void updateData() {
		if (this.good != null) {
			this.nameField.setText(this.good.getName() != null ? this.good
					.getName() : "");
			this.primaryBarcodeField
					.setText(this.good.getPrimaryBarcode() != null ? this.good
							.getPrimaryBarcode() : "");
			this.partialSellingField
					.setSelected(this.good.getPartialSelling() != null ? this.good
							.getPartialSelling() : false);
			this.countPerBoxField
					.setText(String.valueOf(this.good.getCountPerBox() != null ? this.good
							.getCountPerBox() : 0L));
			this.countSellableField.setText(String.valueOf(this.good
					.getCountSellable() != null ? this.good.getCountSellable()
					: 0L));
