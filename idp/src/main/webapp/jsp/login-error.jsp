...
<body>
			...
			<div style="padding: 20px 10px 10px 10px;max-width:640px;">
			  <div  class="alert alert-error">
						...
						<%}
							...
							<b>Назар аударыңыз!</b> <br/>Сіз терген логин немесе құпия сөз дұрыс емес.
						<%} %>
			  </div>
	...
	<div class="container">
		...
		<div class="profile-bar">
			<div class="logo">
				<img src="img/glts/logo.png" width="204" height="65"/>
			</div>
			<div class="name">
			<%if(locale.equals("en")) {%>
				E-learning
		...
		<div class="bg_main">
			...
			<div style="width:400px; margin: 5% auto 0 auto;">
				<form action='j_security_check' method='post'>
					<div class="alert alert-error" style="width: 390px;">
						<%if(locale.equals("en")) {%>
							<b>Attention!</b> <br/>Invalid username or password.
						<%}
						else if(locale.equals("ru")) {
							...
							<div class="controls">
								...
								<label style="display: inline-block; margin-left: 10px;">
									...
									<%}
										...
										<!-- <span style="position: relative; top: 3px;">Менің мәліметтерімді сақтау</span> -->
									<%} %>
								</label>
							</div>
						</div>
